...
TOKEN = os.environ.get("import os, re, io, logging, random
from datetime import time
from groq import Groq
import openpyxl
from supabase import create_client
...
TOKEN = os.environ.get("8611907819:AAGq7Z4363HQtH7FDm-Jgf5R709VoLm5Vd4")
GROQ_KEY = os.environ.get("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")
SUPABASE_URL = os.environ.get("https://uthahxnslvkyancjalyb.supabase.co")
SUPABASE_KEY = os.environ.get("sb_publishable_Vijke-WSUn3MbZV7-t2cJg_flNf3tGO")
CHAT_ID = int(os.environ.get("3795949257", "0"))
OWNER_ID = int(os.environ.get("7063018648", "0"))
